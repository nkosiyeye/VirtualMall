...
import 'package:flutter_store/features/shop/screens/checkout/widgets/billing_address_section.dart';
import 'package:flutter_store/features/shop/screens/checkout/widgets/billing_amount_section.dart';
import 'package:flutter_store/features/shop/screens/checkout/widgets/billing_payment_section.dart';
...
class CheckoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalAmount = TPricingCalculator.calculateTotalPrice(subTotal, 'SWZ');
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          ...
          ,
          child:  Text('Checkout E$totalAmount'),),
      ),
    );
  }
}
